...
let cumLaudeTelling = 0;

for (let i = 0; i < grades.length; i++) {
    if (grades[i] >= 8) {
        cumLaudeTelling = cumLaudeTelling++;

    }
}

console.log(cumLaudeTelling);
...
const averages1 = averageGrade(grades);
const average2 = averageGrade([6, 4, 5]);
const average3 = averageGrade([8, 9, 4, 6, 10]);

console.log(averages1, average2, average3);
